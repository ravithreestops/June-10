            ...
            <React.Fragment>
                ...
                <div className="col edit-inventory">
                    ...
                    <div className="blue-box-div row">
                       ...
                       <div className="col">
                            <div>
                                <span>Hours Commited</span>
                                <input type="text"
                                    className="form-control" defaultValue={this.state.item.hours_commited}
                                    onChange={this.handleChange.bind(this, 'hours_commited')} />
                            </div>
                            <div>
                                <span>Hours Left</span>
                                <input type="text"
                                    className="form-control" defaultValue={this.state.item.hours_left}
                                    onChange={this.handleChange.bind(this, 'hours_left')} />
                            </div>
                       </div>
